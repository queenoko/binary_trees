...
/**
 * binary_tree_is_heap - This checks if a binary tree
...
int binary_tree_is_heap(const binary_tree_t *tree)
{
	if (!tree)
		return (0);
	return (btih_helper1(tree));
}

/**
 * btih_helper1 - This also checks if a binary tree
 * is a valid Max Binary Heap
 * @tree: a pointer to the root node of the tree to check
 *
 * Return: 1 if tree is a valid Max Binary Heap
...
int btih_helper1(const binary_tree_t *tree)
{
	...
	return (btih_helper1(tree->left) &&
		btih_helper1(tree->right));
}
...
int binary_tree_is_complete(const binary_tree_t *tree)
{
	...
	return (btic_helper1(tree, 0, size));
}

/**
 * btic_helper1 - checks if a binary tree is complete
 * @tree: a pointer to the root node of the tree to check
